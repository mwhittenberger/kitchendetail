...
echo <<<HTML
		<div class="blog-yumprint-save blog-yumprint-action"><a onClick="ga('send', 'event', { eventCategory: 'Recipe', eventAction: 'Download', eventLabel: '$title', eventValue: 5});" href="{$yumprint_host}/app/object/{$recipe_id}">$save_recipe_text</a></div>
HTML;
	...
	if ($showPrint) {
echo <<<HTML
		<div class="blog-yumprint-print blog-yumprint-action" onClick="ga('send', 'event', { eventCategory: 'Recipe', eventAction: 'Print', eventLabel: '$title', eventValue: 5});">$print_text</div>
HTML;
	}
