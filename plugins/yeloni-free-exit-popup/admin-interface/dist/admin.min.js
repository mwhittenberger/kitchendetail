    ...
    .service('WidgetUpdate', ['CommService', '$state', '$timeout', 'SettingsService', 'UtilsService', '$rootScope', '$modal', '$q', function(CommService, $state, $timeout, SettingsService, UtilsService, $rootScope, $modal, $q) {
        ...
        */
        ...
        this.changePoweredBy = function(fromCreate) {
            ...
            var message =  "'Powered by Yeloni' message will now be displayed", button = 'Enable'
    ...
    .service('FeatureStatusService', ['$rootScope', function ($rootScope, SettingsService) {
        ...
        this.mobileScreens = function (widget, feature) {
            ...
            return {
                ...
                description: 'More than 50% of visitors browse your website from their Mobiles and Tablets, but in the free version, popups are shown only on deskptop devices. Get this addon to target visitors from all devices.'
            };
        }
        ...
        this.specificPages = function (widget, feature) {
            ...
            return {
                ...
                description: "Show popups on specific pages to personalize your visitor's experience. Using this extension, you can select pages by title, category or url "
            };
        }
        ...
        this.emailSignature = function (widget, feature) {
            ...
            return {
                ...
                upgrade: "Remove yeloni branding from Autoresponder Emails",
                description: "Auto responder messages come with a small footnote. This extension enables you to disable the message"
            };
        }
        ...
        this.premiumEmail = function (widget, feature) {
            ...
            return {
                ...
                description: 'This extension allows you to integrate Yeloni with Aweber, Active Campaign and Sendy'
            };
        }
        ...
        this.limitByReferrer = function (widget, feature) {
            ...
            return {
                ...
                upgrade: 'Target users based on the referring website',
        ...
        this.premiumSubscription = function (widget, feature) {
            ...
            return {
                ...
                upgrade: 'All features at a discounted price (Most Popular)',
