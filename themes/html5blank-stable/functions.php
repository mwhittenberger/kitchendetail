...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
	    ...
	    wp_register_script('fontawesome', get_template_directory_uri() . '/js/fontawesome-all.js', array('jquery'), '1.0.0'); // Custom scripts
	    wp_enqueue_script('fontawesome'); // Enqueue it!
	    wp_localize_script( 'html5blankscripts', 'the_ajax_script', array( 'ajaxurl' => admin_url( 'admin-ajax.php' ) ) );
    }
}
...
function rudr_custom_html_template($html, $id, $caption, $title, $align, $url, $size, $alt) {
   ...
   */
   ...
   if($url){ // if user wants to print the link with image
      $out .= '<a href="' . $url . '" rel="lightbox['.$id.']" vdata-mobile="'.$url .'">';
   }
...
//CUSTOM POST TYPES
	...
	function custom_post_type() {
		...
		$labels = array(
			'name'                  => _x( 'Kitchen Details', 'Post Type General Name', 'text_domain' ),
			'singular_name'         => _x( 'Kitchen Detail', 'Post Type Singular Name', 'text_domain' ),
			'menu_name'             => __( 'Kitchen Details', 'text_domain' ),
		...
		$args = array(
			'label'                 => __( 'Kitchen Detail', 'text_domain' ),
		...
		register_post_type( 'kitchen_detail', $args );
