...
<section>
   <div class="awesome">No need to worry. You are already subscribed to Kitchen Detail. Time to sit back and relax.</div>
               ...
               <div class="content-style-form content-style-form-4">
                  ...
                  <form>
                     <div class="subscribe-wrapper">
                        ...
                        <input type="email" class="my-email" name="email" placeholder="Enter Your Email"><input
                              type="button" value="Subscribe" class="subscribe-me"></div>
                     <!--<div class="sub-messaging">New email subscribers will also receive an exclusive and out of this
                        world recipe from Nancy's archive that can't be found anywhere else.
                     </div>-->
